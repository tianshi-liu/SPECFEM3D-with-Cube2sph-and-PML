...
!  real(kind=CUSTOM_REAL), dimension(:), allocatable :: potential_dot_dot_acoustic_old
  ...
  real, dimension(:,:,:,:), allocatable :: buffer_send_matrix_PML, buffer_recv_matrix_PML
  integer, dimension(:), allocatable :: request_send_matrix_PML
  integer, dimension(:), allocatable :: request_recv_matrix_PML
  real(kind=CUSTOM_REAL), dimension(:,:,:,:,:,:), allocatable :: Qu,Qu_t
  !real(kind=CUSTOM_REAL), dimension(:,:,:,:,:), allocatable :: pml_sigma
  real(kind=CUSTOM_REAL), dimension(:,:,:), allocatable :: Qt,Qt_t
  !real(kind=CUSTOM_REAL), dimension(:), allocatable :: rvolume_ext
  !real(kind=CUSTOM_REAL), dimension(:,:,:), allocatable :: Qt_t_ext
end module pml_par

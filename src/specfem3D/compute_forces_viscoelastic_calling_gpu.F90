...
subroutine compute_forces_viscoelastic_ADE_GPU_calling()
  ...
  integer:: iphase
  logical :: ADE_CONTRIB
  logical :: backward_simulation = .false.
  ...
  do iphase = 1,2 
    ...
    call sync_accel_bdry_buffers(Mesh_pointer,iphase,my_neighbors_ext_mesh,&
                                 nibool_interfaces_ext_mesh,backward_simulation)
    if(ADE_CONTRIB) then 
...
subroutine compute_forces_viscoelastic_ADE_GPU_backward_calling()
  use specfem_par
  use specfem_par_acoustic
  use specfem_par_elastic
  use specfem_par_poroelastic
  ...
  !local 
  integer:: iphase
  logical:: backward_simulation = .true.
...
end subroutine compute_forces_viscoelastic_ADE_GPU_backward_calling
...
specfem3D_OBJECTS = \
	...
	$O/compute_forces_viscoelastic_adepml_element.spec.o \
...
## non-cuda version
${E}/xspecfem3D: $(specfem3D_OBJECTS) $(specfem3D_SHARED_OBJECTS) $(specfem3D_CUBE2SPH_OBJECTS)
	@echo ""
	@echo "building xspecfem3D"
	@echo ""
	${FCLINK} -o ${E}/xspecfem3D $(specfem3D_OBJECTS) $(specfem3D_SHARED_OBJECTS) $(specfem3D_CUBE2SPH_OBJECTS) $(MPILIBS) $(VTKLIBS) $(SPECFEM_LINK_FLAGS) 
	@echo ""
...
## pml
$O/adepml_utils.spec.o: $O/pml_par.spec_module.o
$O/compute_coupling_acoustic_el.spec.o: $O/pml_par.spec_module.o
$O/compute_coupling_viscoelastic_ac.spec.o: $O/pml_par.spec_module.o
$O/compute_forces_acoustic_calling_routine.spec.o: $O/pml_par.spec_module.o
$O/compute_forces_acoustic_NGLL5_fast.spec.o: $O/pml_par.spec_module.o
$O/compute_forces_acoustic_NGLLnot5_generic_slow.spec.o: $O/pml_par.spec_module.o
$O/compute_energy.spec.o: $O/pml_par.spec_module.o
$O/pml_allocate_arrays.spec.o: $O/pml_par.spec_module.o
$O/pml_compute_accel_contribution.spec.o: $O/pml_par.spec_module.o
$O/pml_compute_memory_variables.spec.o: $O/pml_par.spec_module.o
$O/pml_output_VTKs.spec.o: $O/pml_par.spec_module.o
$O/read_mesh_databases.spec.o: $O/pml_par.spec_module.o
$O/read_adepml_files.spec.o: $O/pml_par.spec_module.o
$O/update_displacement_scheme.spec.o: $O/pml_par.spec_module.o

## fault
$O/fault_solver_dynamic.spec.o: $O/fault_solver_common.spec.o
$O/fault_solver_kinematic.spec.o: $O/fault_solver_common.spec.o
$O/compute_forces_viscoelastic.spec.o: $O/pml_par.spec_module.o $O/fault_solver_dynamic.spec.o
$O/compute_forces_viscoelastic_calling_routine.spec.o: $O/pml_par.spec_module.o $O/fault_solver_dynamic.spec.o $O/fault_solver_kinematic.spec.o

$O/prepare_timerun.spec.o: $O/pml_par.spec_module.o $O/fault_solver_dynamic.spec.o $O/fault_solver_kinematic.spec.o

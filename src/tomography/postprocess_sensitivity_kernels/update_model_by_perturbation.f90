program update_model_by_perturbation
  ...
  integer :: nker, nmod, i, ier, imod, iker
  real(kind=CUSTOM_REAL), dimension(:,:,:,:,:), allocatable :: &
                                   old_mod_array, new_mod_array, ker_array
  real(kind=CUSTOM_REAL) :: step_len, max_perturbation
...
end program update_model_by_perturbation

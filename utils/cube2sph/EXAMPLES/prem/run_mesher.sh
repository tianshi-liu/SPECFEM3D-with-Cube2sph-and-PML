...
cp DATA/meshfem3D_files/Mesh_Par_file_220 DATA/meshfem3D_files/Mesh_Par_file
cp DATA/meshfem3D_files/interfaces_220.dat DATA/meshfem3D_files/interfaces.dat
# stores setup

...
!! TL: add parameters to accomodate ADE-PML
  double precision, parameter :: PML_KAPPA0 = 1.0
  double precision, parameter :: MPML_P = 0.0d0
  double precision, parameter :: PML_P = 1.0
